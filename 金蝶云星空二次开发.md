...
![云星空BOS二次开发 (1)](D:\代码\金蝶云星空二次开发.assets\云星空BOS二次开发 (1).svg)
...
1. Administrator账户忘记密码可进入管理中心—选中数据中心后重置其密码
...
4.打开应用时显示【XXX is already locked】 删除应用根目录下的.svn文件夹即可。
...
> API文档 https://vip.kingdee.com/article/131834587734451200
