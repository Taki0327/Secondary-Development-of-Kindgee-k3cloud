...
```c#
Circulation(this.Model.GetValue("F_PZYH_MulBase1"), i++);
...
public void Circulation(Object obj,int i)
{
    ...
    {
        a.Add(ob[$"F_PZYH_MulBase{i}_Id"]);
    }
    //列表赋值
    this.View.Model.SetValue($"F_PZYH_MulBase{i}", a);
    //对象取值
    obj = this.Model.GetValue($"F_PZYH_MulBase{i}");
    a.Clear();
}
```
...
private void ReBuildFields(int fieldCount)
{
    ...
    //页面单据体显示尺寸
    this.View.GetControl("F_PZYH_SpliteContainer").SetCustomPropertyValue("width", Convert.ToInt32(Convert.ToString(YCLINFO["width"])));
    this.View.GetControl("F_PZYH_SpliteContainer").SetCustomPropertyValue("height", Convert.ToInt32(Convert.ToString(YCLINFO["height"])));
...
private void SetData()
{
    ...
    //this.View.Model.SetValue("F_PZYH_MulBase1", );
    //this.View.Model.SetValue("F_PZYH_MulBase2", );
    //this.View.Model.SetValue("F_PZYH_MulBase3",);
...
随后在打开的页面中找到**BOS平台**，**打开虚拟邮箱开关**，选择需要的**虚拟账户**：
